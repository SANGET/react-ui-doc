...
import NotifyConfigC from '@deer-ui/core/notification/doc-api/notify-config'
import NotifyParamsC from '@deer-ui/core/notification/doc-api/notify-params'
...
```js
import { EventEmitter } from '@mini-code/base-func'
import { NotifyEvent } from '@deer-ui/core/notification'
...
```js
import { Notify, CancelNotify } from '@deer-ui'
